...
# Checkbox
checkbox_uppercase = tk.Checkbutton(master=window, text='Uppercase (A, B, C, ...)')
checkbox_uppercase.grid()

checkbox_lowercase = tk.Checkbutton(master=window, text='Lowercase (a, b, c, ...)')
checkbox_uppercase.grid()

checkbox_digit = tk.Checkbutton(master=window, text='Digits (0, 1, 2, ...)')
checkbox_uppercase.grid()

checkbox_minus = tk.Checkbutton(master=window, text='Minus (-)')
checkbox_uppercase.grid()

checkbox_underline = tk.Checkbutton(master=window, text='Underline (_)')
checkbox_uppercase.grid()
...
checkbox_brackets = tk.Checkbutton(master=window, text='Brackets ([, ], {, }, (, ), <, >)')
checkbox_uppercase.grid()
