...
labelframe_settings.grid(row=2, column=0, columnspan=5, padx=(10, 10), pady=(20, 0), sticky='EW')
...
labelframe_generated_password.grid(row=3, column=0, ipadx=120, padx=(10, 10), pady=(20, 20))


labelframe_buttons = tk.LabelFrame(
    master=window,
)
labelframe_buttons.grid(row=4, column=0, ipadx=15, ipady=0, padx=(10, 10), )
...
entry_generated_password.grid(row=0, column=2, )
...
button_close.grid(row=0, column=4, ipadx=20, ipady=10)
...
button_about.grid(row=0, column=2, ipadx=20, ipady=10)
...
button_about.grid(row=0, column=3, ipadx=20, ipady=10)
